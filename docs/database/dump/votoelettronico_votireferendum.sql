...
--
-- Table structure for table `votireferendum`
--

DROP TABLE IF EXISTS `votireferendum`;
...
--
-- Dumping data for table `votireferendum`
--

LOCK TABLES `votireferendum` WRITE;
/*!40000 ALTER TABLE `votireferendum` DISABLE KEYS */;
/*!40000 ALTER TABLE `votireferendum` ENABLE KEYS */;
UNLOCK TABLES;
