...
public class AutenticazioneVotazioneController extends Controller{
    ...
    void pressVotaButton(ActionEvent event) {
    	...
    	if (elettore == null) { erroreLabel.setVisible(true);}
	    	else {
    ...
    void initialize() {
        ...
        assert votaBottone != null : "fx:id=\"votaBottone\" was not injected: check your FXML file 'AutenticazioneVotazioneView.fxml'.";
